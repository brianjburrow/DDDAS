%[impl,x,y,extras] = SimAdaptiveNoisySKO_v2(N,sample,dim,n0a,n0b,MPerDim,scale0,g0)
%
...
% the hyperparameters on each iteration.  Similar to SimAdaptiveNoisySKO,
...
%
function [impl,x,y,extras] = SimAdaptiveNoisySKO_v2(N,sample,dim,n0a,n0b,MPerDim,scale0,g0)
    M = MPerDim^dim;
