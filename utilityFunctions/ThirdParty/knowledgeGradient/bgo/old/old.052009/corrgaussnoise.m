...
%CORRGAUSSNOISE  Gaussian correlation function, with measurement noise.
%
%             n
%   r_i = g * prod exp(-theta_j * d_ij^2) ,  i = 1,...,m
%             j=1
%
% The parameter g is stored as theta(n+1).  g is the ratio of process variance
% divided by (process variance + measurement noise variance).  Fixing it to 1
% gives the case with no measurement noise.
%
